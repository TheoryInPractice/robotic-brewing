...
std::vector<algorithm::exact::algebraic::CompactStrategy> compact_strategies = {
    algorithm::exact::algebraic::CompactStrategy::Naive, algorithm::exact::algebraic::CompactStrategy::Standard,
