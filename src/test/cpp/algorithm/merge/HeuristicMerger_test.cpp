...
static VI run_merge(HeuristicMerger& merger, Graph const& graph, VVI const& walks) {
...
TEST(HeuristicMergerTest, Merge) {
  ...
  // Heuristic gives a suboptimal solution.
  Graph g5;
